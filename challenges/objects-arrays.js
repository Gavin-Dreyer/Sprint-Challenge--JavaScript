...
zooAnimals.map(function(data) {
  lowCaseAnimalNames.push(data.animal_name.toLocaleLowerCase())
})
...
const smallPop = zooAnimals.filter(function(data){
